...
/**
 * ストアに並んでいる作品。表示のたびにこの中からランダムで8件出す。
 * サムネイルは取り違えを防ぐため、公式ストアの商品画像を取り込んで public/store/ に置いている。
 */
export const storeItems: StoreItem[] = [
  { id: '36404994', name: 'オカン。とムスコ。関西弁の親子', note: '親子の会話がそのまま使える' },
  { id: '36440804', name: 'オカン。とムスコ。ともちぴ。', note: 'もちぴも仲間入りした3人セット' },
  { id: '36440775', name: 'オカン。とムスコ。ときぐるみっこ。連絡', note: '家族の業務連絡はこれで足りる' },
  { id: '36425712', name: 'オカン。とムスコ。ときぐるみっこ。', note: 'きぐるみっこも一緒のにぎやか版' },
  { id: '36440856', name: 'オカン。ともちぴ', note: 'オカン。ともちぴの2人だけ' },
  { id: '36391279', name: 'あゆとオカン。全国いくで', note: '作者・あゆとオカン。の2人旅' },
  { id: '36390622', name: 'オカン。毎日使える関西弁スタンプ', note: 'まずはこれ。朝から夜までの定番' },
  { id: '36390574', name: 'オカン。見やすいデカ文字スタンプ', note: '文字が大きい。親世代にも読みやすい' },
  { id: '36404915', name: '無言でも圧が強いオカン。', note: '何も言うてへんのに圧がすごい' },
  { id: '36391219', name: '朝からうるさいオカン。', note: '起きた瞬間から元気' },
  { id: '36391210', name: '褒めまくるオカン。', note: 'とにかく褒める。元気が出るやつ' },
  { id: '36391266', name: '体調を気づかうオカン。', note: '無理してへんか、と聞いてくる' },
  { id: '36391313', name: '夜ふかしを止めるオカン。', note: 'そろそろ寝なさい、の圧' },
  { id: '36391344', name: 'ごはんをすすめるオカン。', note: 'とりあえず食べとき' },
  { id: '36391376', name: '返信を催促するオカン。', note: '既読つけたやろ、が飛んでくる' },
  { id: '36391421', name: '仕事を応援するオカン。', note: '働く人の背中を押すシリーズ' },
  { id: '36391427', name: '恋愛相談に乗るオカン。', note: '踏み込んでくるオカン。の恋愛相談' },
  { id: '36391454', name: '節約に厳しいオカン。', note: 'そのお金、ほんまに要る？' },
  { id: '36404925', name: '季節のあいさつオカン。', note: '年賀・暑中見舞いもオカン。で' },
  { id: '36404930', name: 'お出かけを見守るオカン。', note: '気をつけて行きや、の一言' },
  { id: '36404966', name: 'お祝いしまくるオカン。', note: 'おめでとうを全力で伝える' },
  { id: '36404412', name: '運動を応援するオカン。', note: '走る人・がんばる人へ' },
  { id: '36440609', name: '家事を頼むオカン。', note: 'ちょっとこれやっといて、の連絡' },
  { id: '36440694', name: '飲み会を見守るオカン。', note: '飲みすぎんときや' },
